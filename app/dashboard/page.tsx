...
// Bulletproof logic: Find the first module that isn't fully completed. 
  ...
  return (
    <div className="max-w-4xl mx-auto animate-in fade-in duration-500 pb-24">
      ...
      <div className="bg-ink text-white p-8 md:p-10 shadow-lg flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-16 rounded-none">
        <div>
        ...
        <Link href={`/dashboard/lessons/${nextModule.module_id || 1}`} className="w-full md:w-auto shrink-0">
          <button className="w-full bg-brand hover:bg-brand-dark text-ink font-bold text-sm px-8 py-4 transition-colors shadow-sm flex items-center justify-center gap-2">
