...
export default function Home() {
  ...
  const sendToBackend = async (formData: FormData) => {
    ...
    try {
      ...
      // --- NEW: CHRONOLOGICAL PLAYBACK LOOP ---
  ...
  return (
    <main className="flex flex-col h-screen bg-slate-50 text-slate-800 font-sans">
      <header className="flex items-center justify-center p-5 bg-white border-b border-slate-200 shadow-sm z-10">
