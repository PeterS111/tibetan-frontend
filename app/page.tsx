      ...
      <div className="bg-[#61241a] text-white py-24 sm:py-32 px-6 overflow-hidden">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative z-10 hidden md:block">
            ...
            <div className="absolute -left-12 -bottom-6 bg-white rounded-2xl p-4 shadow-2xl z-20 border border-stone-200 font-sans animate-bounce" style={{animationDuration: '4s'}}>
            ...
            {/* Main Mockup Box */}
            <div className="bg-white rounded-3xl p-6 md:p-8 shadow-2xl border border-stone-200 transform rotate-1 hover:rotate-0 transition-transform duration-500">
              ...
              <div className="flex items-center gap-4 text-stone-400 bg-stone-50 border border-stone-200 p-3 rounded-xl font-sans">
                <button className="w-8 h-8 rounded-full bg-white border border-stone-200 flex items-center justify-center text-[#85443d] shadow-sm hover:scale-105 transition"><Play size={14} className="fill-current" /></button>
